                ...
                !showResult ? (
                    <div className='option-wrapper'>
                        ...
                        <div className='options'>
                            {
                                questions[currentQuestion].options.map(optionsItem => (
                                    <button key={optionsItem}
                                        className={`option ${selectedOptions[currentQuestion] === optionsItem ? 'selected' : ''}`}
                                        onClick={() => handleSelectedOption(optionsItem)}
                                    >
                                        {optionsItem}
                                    </button>
                                ))
